...
ggsave("RAFs.png", path="figures/nasal-swabs", width=16, height=8)
...
ggsave("rafs_sample_facet.png", path="figures/nasal-swabs", width=8, height=10)
...
ggsave("lines.png", path="figures/nasal-swabs", width=16, height=8)
...
df_ %>%
  ...
  main_theme
ggsave("figures/nasal-swabs/ridges.png", width=12, height=8)
